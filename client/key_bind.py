...
root.bind('<KeyPress-h>', lambda _: send('headhome'))
root.bind('<KeyPress-i>', lambda _: send('headup'))
root.bind('<KeyPress-k>', lambda _: send('headdown'))
root.bind('<KeyPress-x>', call_find_color)
root.bind('<KeyPress-c>', call_watchdog)
root.bind('<KeyPress-b>', lambda _: send('stream_audio'))
